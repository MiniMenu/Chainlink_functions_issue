...
contract Ticket is ERC721, ERC721URIStorage, VRFConsumerBaseV2Plus {
   ...
   /**
    ...
    constructor(uint256 _subscriptionId) ERC721("Chainlink Superliga FootBall 2024", "CSF")
    VRFConsumerBaseV2Plus(vr_coordinator) {
         COORDINATOR = IVRFCoordinatorV2Plus(
            vr_coordinator
        );
        s_subscriptionId = _subscriptionId;
        convertPrice = PriceConverterInterface(0x44B88c7c5d20DbcB733a76C8e439D6684818190B);
        nftMetaData = NFTMetaDataGeneratorInterface(0xd09C3710BE82eF60C77891f786b7c5d22cED8675);
    ...
    */
    ...
    /** 
      @notice Update the NFT meta data's
